...
<body>
    ...
    <div class="container-fluid p-0 mb-3">
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-2 py-lg-0 px-lg-5">
            <a href="" class="navbar-brand d-block d-lg-none">
                <h1 class="m-0 display-5 text-uppercase"><img src="logo.png" alt="" height="60px"><span
                        class="text-primary">ನಮ್ಮೂರ </span>ವಾರ್ತೆ</h1>
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="index.php" class="nav-item nav-link active"> <i class="fa fa-home " aria-hidden="true"
        ...
        <div class="row">
            <div class="col-lg-8 ">
                <div class="owl-carousel owl-carousel-2 carousel-item-1 position-relative mb-3 mb-lg-0">
                    ...
                    <?php
                    $q1 = mysqli_query($db, "select * from news order by id desc limit 3");
                    while ($r1 = mysqli_fetch_array($q1)) {
                        ?>
                        <div class="position-relative overflow-hidden" style="height: 495px;">
                            <img class="img-fluid h-100" src="admin/news_images/<?= $r1[3] ?>" style="object-fit: cover;">

                            <div class="overlay">
                                <div class="mb-1">
                                    <a class="text-white text-decoration-none" href="news.php?id=<?= $r1[0] ?>"> <?= $r1[5] ?></a>
                                    <span class="px-2 text-white">/</span>
                                    <a class="text-white" href="">
                                        <?= date('d-m-Y ,', strtotime($r1[9])) ?></span><span style="float: right;">
                                            <?= date('h:i a', strtotime($r1[10])) ?>
                                    </a>
                                </div>
                                <a class="h2 m-0 text-white font-weight-bold" href="news.php?id=<?= $r1[0] ?>">
                                    <?= $r1[2]; ?>
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                ...
                <?php
                $q1 = mysqli_query($db, "select * from ads order by id desc limit 1");
                while ($r1 = mysqli_fetch_array($q1)) {
                    ?>
                    <div><embed src="admin/advrt/<?= $r1['ads'] ?> " height="90%" width="100%"></embed>
                    </div>
                    <?php
                }
                ?>
    ...
    <div class="row justify-content-center  catWithAds ">
                    ...
                    <div class="owl-carousel owl-carousel-3 carousel-item-2 position-relative">
                        ...
                        while ($r1 = mysqli_fetch_array($q1)) {
                            ...
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="admin/news_images/<?= $r1[3] ?>" style="height:250px">
        ...
        <div class="ads col-lg-3">
            ...
            while ($r1 = mysqli_fetch_array($q1)) {
                ?>
                <div><embed src="admin/advrt/<?= $r1['ads'] ?> " height="300px" width="100%"></embed>
                </div>
                <?php
            }
            ?>
            ...
            <div class=" row justify-content-center">
                ...
                <div class="col-lg-2 col-md-6 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <i class=" text-dark mr-2 text-secondary mb-2"></i>
                        <i class="  text-dark mr-2 text-secondary mb-2">1st Floor, Beside to Police Station</i>
                        <i class=" text-dark mr-2 text-secondary mb-2">Bharathi Street, opp. to Canara Bank</i>
                        <i class="  text-dark mr-2 text-secondary mb-2">Sringeri, Karnataka 577139</i>
                        <i class="  text-dark mr-2 text-secondary mb-2"></i>
                        <i class=" text-dark mr-2 text-secondary mb-2">Tel: +91 9876543210</i>
                        <i class=" text-dark mr-2 text-secondary mb-2">Email: info@nammuravarthe.com</i>
