                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#smallmodal">Add Categories</button>
                                    </div>
                                    <div class="col-sm-12">
                                        <?php
                                    ...
                                    <tbody>
                                        ...
                                        while ($r = mysqli_fetch_array($q)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="categories1.php" method="post">
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="smallmodalLabel">Add Categories</h5>
            ...
            <div class="modal-body">
                <form action="categories1.php" method="post" novalidate="novalidate">
                    
                    <div class="form-group">
                        <label for="cc-payment" class="control-label mb-1">Category in Kannada</label>
...
<div class="modal fade" id="smallmodal1" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="smallmodalLabel">Edit Categories</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
