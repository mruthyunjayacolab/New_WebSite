...
<head>
    ...
    <title>ನಮ್ಮೂರ ವಾರ್ತೆ | Nammoora Varthe</title>
    <meta name="description" content="ನಮ್ಮೂರ ವಾರ್ತೆ | Nammoora Varthe">
...
<link rel="stylesheet" href="/templates/ajt005_j30/bootstrap/css/bootstrap.min.css" type="text/css" /><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><script>  (adsbygoogle = window.adsbygoogle || []).push({    google_ad_client: "ca-pub-3692598216790159",    enable_page_level_ads: true  });</script>
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="categories.php"> <i class="menu-icon fa fa-laptop"></i>Categories </a>
                    </li>
                    <li>
                        <a href="breaking_news.php"> <i class="menu-icon fa fa-table"></i>Breaking News </a>
                    </li>
                    <li>
                        <a href="news.php"> <i class="menu-icon fa fa-th"></i>News Details </a>
                    </li>
                    <li>
                        <a href="advertisement.php"> <i class="fas fa-th" style="height:50px; width:50px">Advertisement </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="img/admin.png" alt="User Avatar">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#" data-toggle="modal" data-target="#smallmodals"><i class="fa fa-user"></i> My Profile</a>
        ...
        <!-- Header-->
        <div class="modal fade" id="smallmodals" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form action="profile.php" method="post" novalidate="novalidate">
                          <?php
                          $qry = mysqli_query($db,"select * from admin");
                          ...
                          ?>
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?= $row[1]?>" required>
                            </div>
                            <div class="form-group">
                                <label for="cc-payment" class="control-label mb-1">Password</label>
                                <input name="password" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?= $row[2]?>" required>
                            </div>
                          <?php
                          }
                          ?> 
